        ...
        axios
          ...
          .then(function (response) {
            if (response.data.codigo === 1) {
              swal("Sucesso", "Unidade de medida cadastrada com sucesso", "success");
              resetCampo();
              ...
              <Form noValidate autoComplete="off">
                <Row>
                  <Col md={6} xs={6}>
                    ...
                    />
                    {userId.length === 0 && enviado ? <ValidaCampos value={'Usuário'}></ValidaCampos> : ''}
                  </Col>
                  <Col md={6} xs={6}>
                    <TextField
                      id="siga"
                    ...
                    />
                    {siga.length === 0 && enviado ? <ValidaCampos value={'Senha'}></ValidaCampos> : ''}
                  </Col>
                </Row>
                <Row className="mt-3">    
                  <Col md={12} xs={12}>
                      ...
                      />
                      {descricao.length === 0 && enviado ? <ValidaCampos value={'Tipo de Usuário'}></ValidaCampos> : ''}
                  </Col>
                </Row>
              </Form>
            </Card.Body>
